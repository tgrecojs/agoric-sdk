...
bin/agops ec committee --send-from airdrop-claimant-427 --keyring-backend="test"

# Accept invitation to be a charter member
bin/agops ec charter --send-from airdrop-claimant-427 --keyring-backend="test"
...
agoric wallet send --offer "$PROPOSAL_OFFER" --from airdrop-claimant-427 --keyring-backend="test"

# vote on the question that was made
bin/agops ec vote --forPosition 0 --send-from airdrop-claimant-427 --keyring-backend="test" "$COMMITTEE_OFFER_ID"
...
agoric wallet send --offer "$SWAP_OFFER" --from airdrop-claimant-427 --keyring-backend="test"
